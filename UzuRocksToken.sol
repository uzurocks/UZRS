...
contract UzuRocksToken is ERC20, Pausable, Ownable, ERC20Burnable {
    ...
    function setLock(address account, uint256 amount) onlyOwner public returns (bool) {
    ...
    function multiLock(address[] memory accounts, uint256[] memory amounts) onlyOwner public returns (bool) {
